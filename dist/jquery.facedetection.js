                    ...
                    for (i = 0; i < worker_num; i++) {
                        ...
                        worker.onmessage = function(i) {
                            return function(event) {
                                ...
                                ++executed == worker_num && complete(ctrl.post.apply(scope, [ outputs ]));
                            };
                        }(i);
                        var msg = {
                            input: inputs[i],
                                    ...
                                    for (k = 0; k < cascade.stage_classifier[j].count; k++) {
                                        ...
                                        if (pmin <= nmax) sum += alpha[2 * k]; else {
                                            ...
                                            for (f = 0; f < feature_k.size; f++) {
                                                if (feature_k.pz[f] >= 0 && (p = u8[feature_k.pz[f]][u8o[feature_k.pz[f]] + feature_k.px[f]]) < pmin) {
                                                    if (p <= nmax) {
                                                        shortcut = !1;
                                                        break;
                                                    }
                                                ...
                                                if (feature_k.nz[f] >= 0 && (n = u8[feature_k.nz[f]][u8o[feature_k.nz[f]] + feature_k.nx[f]]) > nmax) {
                                                    if (pmin <= n) {
                                                        shortcut = !1;
                                                        break;
                                                    }
